...
const verticals = [
    { industry: "Real estate agents", href: "/", emoji: "🏡", cta: "Follow-up system for agents" },
...
export default function OptionD() {
    ...
    return (
        <main>
            {/* Hero — brand/company positioning */}
            <section className="bg-[url('/assets/hero-gradient-bg.png')] bg-cover bg-center bg-no-repeat px-4 md:px-16 lg:px-24 xl:px-32">
                <div className="max-w-7xl mx-auto flex flex-col items-center justify-center h-screen text-center">
                    ...
                    <AnimatedContent className="flex flex-col md:flex-row items-center gap-4 mt-8 w-full md:w-auto" delay={0.3}>
                        <button
                            onClick={() => openAiModal("Option D — Hero")}
                ...
                <div className="max-w-7xl mx-auto border-x border-[#edf9f8]">
                    <div className="relative p-8 md:p-16 grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {[
                            {
                                title: "We build it",
                                body: "No templates, no platform to log into. We build the system from scratch, tailored to how your business actually works.",
                            },
                            {
                                title: "We run it",
                                body: "Leads get responses. Follow-ups go out. Reviews get replied to. It runs in the background while you do the actual work.",
                            },
                            {
                                title: "We maintain it",
                                body: "If something breaks or needs adjusting, we fix it.",
                            },
                        ].map((item, i) => (
                ...
                <div className="max-w-7xl mx-auto border-x border-[#edf9f8]">
                    <div className="relative p-8 md:p-16">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 auto-rows-[160px] gap-3">
                            ...
                            {/* Real estate — wide, tall */}
                            <AnimatedContent delay={0} className="col-span-2 row-span-2">
                                <div className="bento-card bento-purple" style={{ animationDuration: "14s" }}>
                                    <Link href="/" className="bento-card-inner group flex flex-col justify-between p-6 bg-[#f9fafb] hover:bg-purple-50 transition-all">
                ...
                <div className="max-w-7xl mx-auto border-x border-[#edf9f8]">
                    <div className="p-8 md:p-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <AnimatedContent className="relative">
                            ...
                            <button
                                onClick={() => openAiModal("Option D — Why us CTA")}
                ...
                <div className="max-w-7xl mx-auto">
                    <AnimatedContent className="text-center flex flex-col items-center">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 mt-8">
                            <button
                                onClick={() => openAiModal("Option D — Final CTA")}
                            ...
                            >
                                Work with us — it&apos;s free <ArrowUpRightIcon size={16} />
                            </button>
