...
import { ArrowUpRightIcon, CheckIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, PhoneCallIcon, XIcon } from "lucide-react";
...
const missedCases = [
    {
        time: "Mon 9:43 am",
        source: "Inbound call",
        sourceKey: "phone" as const,
        inquiry: "Hi, I'd like to schedule a viewing for the property on Elm Street.",
        missed: "→ Voicemail",
    ...
    },
    {
        ...
        source: "Inbound call",
        sourceKey: "phone" as const,
        inquiry: "Do you have anything in the $600k range with a garage? We're ready to move fast.",
        missed: "→ No answer",
    ...
    },
    {
        ...
        source: "Inbound call",
        sourceKey: "phone" as const,
        inquiry: "We just got pre-approved. Can we see something this weekend?",
        missed: "→ Voicemail",
        outcome: "Went with another agent",
    },
];
...
const sourceAvatars: Record<string, { bg: string; el: React.ReactNode }> = {
    phone: {
        bg: "bg-zinc-100",
        el: <PhoneCallIcon size={22} className="text-zinc-500" />,
    },
    zillow: {
        bg: "bg-[#006AFF]/10",
        el: (
...
const features = [
    {
        title: "Answer every call, even when you can't",
        body: "You're mid-showing. A lead calls. Your agent picks up, qualifies them, and books the viewing. You get the summary when you're done.",
    },
    {
        title: "Filter out the tyre-kickers before they reach you",
        body: "Your agent asks the right questions and passes you the buyers worth your time. You stop spending 20 minutes on someone who's just browsing.",
    },
    {
        title: "Reactivate leads you forgot about",
        body: "Contacts who went quiet get a re-engagement sequence on a schedule. Your agent flags whoever replies and books them back in.",
    },
    {
        title: "Answer every question about your listings",
        body: "Price, availability, parking, viewings — your agent pulls from your listing sheet and responds instantly.",
    },
];
...
const steps = [
    ...
    {
        n: "02",
        title: "We build your voice agent from scratch",
        body: "No templates, no platform to figure out. Built around your name, your listings, and your call flow.",
    },
    {
        n: "03",
        title: "It runs automatically",
        body: "Calls get answered. Viewings get booked. Cold leads get followed up. You get a daily summary.",
    },
    {
        n: "04",
        title: "We keep it running",
        body: "New listings, updated availability, seasonal changes — we handle it. You don't manage anything.",
    },
];
...
const faqs = [
    {
        ...
        a: "Some will, some won't. It's built to sound clear and helpful, not robotic. Most callers care more about getting a fast answer than who — or what — gave it to them.",
    },
    {
                ...
                <div className="max-w-7xl mx-auto flex flex-col items-center justify-center h-screen">
                    ...
                    <AnimatedContent distance={30} delay={0.1}>
                        <h1 className="text-center font-urbanist text-5xl/15 md:text-6xl/18 mt-4 font-bold max-w-3xl">
                            <span className="text-gray-800">78% of buyers work with whoever picks up first.</span>
                        </h1>
                    </AnimatedContent>

                    <AnimatedContent distance={30} delay={0.2}>
                        <p className="text-center text-base/7 text-zinc-500 max-w-xl mt-3">
                            We make sure that&apos;s always you. A voice agent that answers every call, qualifies every lead, and books viewings — even when you&apos;re mid-showing.
                        </p>
                    </AnimatedContent>
                ...
                <div className="max-w-7xl mx-auto border-x border-[#edf9f8]">
                    <div className="p-8 md:p-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
                        {[
                            ...
                            { value: "$7,500+", label: "in commission lost per missed lead" },
                ...
                <div className="max-w-7xl mx-auto border-x border-[#edf9f8]">
                    <div className="p-8 md:p-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                        <div className="md:sticky md:top-26 flex flex-col gap-6">
                            <AnimatedContent>
                                ...
                                <h2 className="font-urbanist font-semibold text-3xl md:text-4xl text-gray-800">
                                    Missed calls don&apos;t wait. They go to the next agent on the list.
                                </h2>
                                <p className="text-zinc-500 text-base/7 mt-4">
                                    A buyer calls while you&apos;re showing a property. A lead reaches out on Sunday evening. You&apos;re doing the job — and by the time you&apos;re free, they&apos;ve already signed with someone else.
                                </p>
                                <p className="text-zinc-500 text-base/7 mt-3">
                                    There&apos;s a gap between when leads call and when you can answer. Every gap is a commission.
                                </p>
                            </AnimatedContent>
                            <AnimatedContent className="p-4 md:p-6 bg-purple-500 w-full rounded-xl">
                                <p className="text-base text-white">
                                    We build the agent. We run it. You don&apos;t manage anything.
                                </p>
                                <button
                        ...
                        <div className="flex flex-col items-center justify-center py-8">
                            <p className="text-sm text-zinc-400 mb-8 text-center">Every one of these went to the next agent who picked up.</p>
                        ...
                        <div className="p-4 pt-16 md:p-16 flex flex-col items-start md:sticky md:top-26">
                            <AnimatedContent>
                                ...
                                <p className="text-zinc-500 text-base/7 mt-4 max-w-sm">
                                    Answers calls. Books viewings. Follows up leads. You find out after.
                                </p>
                ...
                <div className="max-w-7xl mx-auto border-x border-[#edf9f8]">
                    <div className="p-8 md:p-16">
                        <AnimatedContent className="text-center mb-12">
                            <h2 className="font-urbanist font-semibold text-3xl md:text-4xl text-gray-800">What happens while you&apos;re mid-showing</h2>
                        </AnimatedContent>
                    ...
                    <div>
                        <div className="p-4 pt-16 md:p-16 flex flex-col items-start md:sticky md:top-26">
                            <AnimatedContent>
                                ...
                                <p className="text-zinc-500 text-base/7 mt-4 max-w-sm">
                                    This isn&apos;t a tool you configure. We build your voice agent from scratch, set it up around how you work, and keep it running. You don&apos;t log in to manage it. You just close the deals.
                                </p>
                            </AnimatedContent>
                            <AnimatedContent delay={0.1} className="p-4 md:p-6 bg-purple-500 w-full rounded-xl mt-8">
                                <button
                                    ...
                                    className="bg-white hover:bg-gray-100 transition-colors px-5 py-2 rounded-full flex items-center gap-1 text-sm font-medium w-max"
                                >
                                    Set up your agent — it&apos;s free
                                    <ArrowUpRightIcon size={16} />
                                </button>
                        ...
                        <div className="p-8 md:p-16">
                            <AnimatedContent className="mb-8">
                                ...
                                <p className="text-zinc-500 text-sm/6 mt-2">
                                    We&apos;re doing free setups for a small number of real estate agents right now. You get a fully working voice agent built for your business. We ask for feedback and a case study if it works. That&apos;s it.
                                </p>
                    ...
                    <div className="p-8 md:p-16 pb-24 md:pb-32 flex flex-col items-center text-center">
                        <AnimatedContent>
                            ...
                            <p className="text-zinc-500 text-base/7 mt-4 max-w-md mx-auto">
                                Free setup. No credit card. We&apos;re opening this up to a small number of agents right now.
                            </p>
                            ...
                            <p className="text-xs text-zinc-400 mt-4">Limited spots. No strings.</p>
                        </AnimatedContent>
                    </div>
                </div>
                <button
