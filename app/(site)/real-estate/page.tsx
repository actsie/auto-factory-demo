...
const features = [
    {
        ...
        body: "You're mid-showing. A lead calls. Your agent answers, books the viewing, and tells you after. No missed calls.",
    },
    {
        title: "Qualify leads before they reach you",
        body: "Your agent filters out the tyre kickers and passes you the serious buyers. You spend time on leads that matter.",
    },
    {
        title: "Follow up on cold leads automatically",
        body: "Contacts who went quiet months ago get re-engaged automatically. Your agent flags whoever's ready to move.",
    },
    {
        title: "Handle the repetitive questions all day",
        body: "Price, availability, viewings — your agent handles all of it. You get your time back.",
    },
];
...
const steps = [
    ...
    },
    {
        ...
        body: "No templates, no platform to log into. Built around your name, your listings, and your call flow.",
    },
    {
        n: "03",
        title: "It runs automatically",
        body: "Calls get answered. Viewings get booked. Cold leads get followed up. You get a daily summary of everything that happened.",
    },
    {
        n: "04",
                ...
                <div className="max-w-7xl mx-auto flex flex-col items-center justify-center h-screen">
                    ...
                    <AnimatedContent distance={30} delay={0.1}>
                        <h1 className="text-center font-urbanist text-5xl/15 md:text-6xl/18 mt-4 font-bold max-w-3xl">
                            <span className="text-gray-800">A voice agent built for real estate agents who can&apos;t afford to miss a call.</span>
                        </h1>
                    </AnimatedContent>

                    <AnimatedContent distance={30} delay={0.2}>
                        <p className="text-center text-base/7 text-zinc-500 max-w-xl mt-3">
                            Every lead gets answered. Every viewing gets booked. Even when you&apos;re with another client.
                        </p>
                    </AnimatedContent>

                    <AnimatedContent distance={30} delay={0.25}>
                        <p className="text-center text-sm text-zinc-400 mt-2">
                            78% of buyers work with the first agent who responds. We make sure that&apos;s always you.
                        </p>
                    </AnimatedContent>
                        ...
                        <div className="md:sticky md:top-26 flex flex-col gap-6">
                            <AnimatedContent>
                                ...
                                <p className="text-zinc-500 text-base/7 mt-4">
                                    A buyer calls while you&apos;re showing a property. Another lead reaches out on Sunday evening. You&apos;re busy doing the job — and by the time you&apos;re free, they&apos;ve already booked with someone else.
                                </p>
                        ...
                        <div className="p-4 pt-16 md:p-16 flex flex-col items-start md:sticky md:top-26">
                            <AnimatedContent>
                                ...
                                <p className="text-zinc-500 text-base/7 mt-4 max-w-sm">
                                    Your voice agent answers every call, qualifies every lead, and books viewings automatically. You come out of every showing with new appointments already waiting.
                                </p>
                    ...
                    <div>
                        <div className="p-4 pt-16 md:p-16 flex flex-col items-start md:sticky md:top-26">
                            <AnimatedContent>
                                ...
                                <p className="text-zinc-500 text-base/7 mt-4 max-w-sm">
                                    This isn&apos;t a platform you log into and figure out. We build your voice agent from scratch, set it up around how you work, and keep it running.
                                </p>
                            </AnimatedContent>
