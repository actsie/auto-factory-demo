...
export const reports: Report[] = [
  ...
  {
    id: "istudios-marketing-agency",
    company: "iStudios Marketing Agency",
    logo: "/assets/reports/istudios-marketing-agency/logo.svg",
    logoNeedsBg: false,
    url: "https://istudiosmedia.com",
    industry: "Video Production & Digital Marketing",
    pages: 7,
    ...
    opportunityFindings: [
      {
        label: "Agency credibility gap",
        body: "iStudios positions around performance and AI-powered results for clients — but internally, every homepage update, new service page, or CTA test still goes through a WordPress developer before it goes live. An agency selling speed and performance marketing shouldn't be slowed down by its own website.",
      },
      {
        label: "Missing structured data",
        body: "Without structured data identifying this as a media and creative studio, search engines can't surface rich results for searches around content production and marketing services. This gap directly limits discoverability for the agency's core offerings.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to lead with 'Stories that Inspire, Media that Moves' — I want it bigger and above the fold on mobile.",
  ...
  {
    id: "keystone-creating-ltd",
    company: "Keystone Creating Ltd.",
    logo: "/assets/reports/keystone-creating-ltd/logo.svg",
    logoNeedsBg: false,
    url: "https://keystone-tw.com",
    industry: "Textile & Materials Supply (Athletic Footwear & Accessories)",
    pages: 5,
    ...
    opportunityFindings: [
      {
        label: "Site bottleneck for clients",
        body: "Keystone supplies top-tier brands like Columbia, PUMA, and New Balance — but every time product specs, fabric descriptions, or the brand story need updating for a new season, it becomes a request waiting in someone else's queue. When clients are moving at the speed of sportswear seasons, the site needs to keep up.",
      },
      {
        label: "Missing structured data",
        body: "Without structured data identifying this as a technology consulting firm, search engines can't surface rich results for the specific tech and consulting searches this firm should be ranking for. This limits visibility to brand buyers actively researching suppliers.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero headline from '頂尖設計師推薦的布料專家' to reflect our new GRS-certified recycled line",
      result1: "✓ Done in minutes — no designer call, no ticket, no waiting.",
      prompt2: "Add a CTA button to the Our Products section so brand buyers can request samples directly",
      result2: "✓ Button added, linked, tested — live the same day you thought of it.",
      prompt3: "We just landed a new client in the lifestyle category — add them to Our Clients",
  ...
  {
    id: "kiwi-biosciences-fodzyme",
    company: "Kiwi Biosciences (FODZYME)",
    logo: "/assets/reports/kiwi-biosciences-fodzyme/logo.svg",
    logoNeedsBg: false,
    url: "https://kiwibiosciences.com",
    industry: "Biotech / Consumer Health (Digestive Enzyme Supplements)",
    pages: 2,
    ...
    opportunityFindings: [
      {
        label: "Slow updates vs. fast science",
        body: "Backed by Y Combinator and solving a real problem for 10% of the planet, with only 2 pages every word has to work hard. When messaging needs a refresh — new clinical data, updated positioning, a new market to address — waiting on a designer to touch the Webflow site is time they don't have.",
      },
      {
        label: "Uncontrolled search snippet",
        body: "Without a meta description, Google writes its own snippet using random page text — making the search result look incomplete and harder to act on for potential partners or buyers. In a category where consumer trust is everything, this is a missed first impression.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero from 'Making food painless for at least 10% of the planet' to lead with our new clinical study results",
  ...
  {
    id: "looking-up-arts-foundation-inc",
    company: "Looking Up Arts Foundation, Inc.",
    logo: "/assets/reports/looking-up-arts-foundation-inc/logo.svg",
    logoNeedsBg: false,
    url: "https://lookingup.art",
    industry: "Nonprofit / Public Art & Community Installations",
    pages: 3,
    ...
    opportunityFindings: [
      {
        label: "Site lags behind the work",
        body: "Looking Up Arts creates bold, interactive public art that brings people together. But when they need to add a new installation, post a volunteer call, or update a patron pitch before a fundraising push, waiting on Wix means the site lags behind the work. For a nonprofit where momentum and donor timing are everything, a slow site is a missed opportunity.",
      },
      {
        label: "No rich search results",
        body: "Only a generic site-level schema is present with no Organization or Event markup, so Google can't surface rich details about this organization's art installations in search results. This limits their ability to attract new patrons, volunteers, and community partners through organic search.",
      },
    ],
    aiExamples: {
      prompt1: "We just launched a new installation — add it to the Artworks section with photos and a description",
  ...
  },
  {
    id: "mango-math-group",
    company: "MANGO Math Group",
    logo: "/assets/reports/mango-math-group/logo.svg",
    logoNeedsBg: false,
    url: "https://mangomath.com",
    industry: "EdTech / Game-Based Math Education (PreK–8)",
    pages: 6,
    ...
    opportunityFindings: [
      {
        label: "Missed buying windows",
        body: "MANGO Math sells directly to schools, districts, and parents. When they need to update a top-seller, push a free shipping promotion, or add a new grade-level kit, every delay between idea and live update costs conversions. In an education sales cycle tied to school calendars, slow site updates mean missed buying windows.",
      },
      {
        label: "No product-level search signals",
        body: "No structured data is present, so Google can't generate rich results like product info or reviews that would help teachers and schools find and evaluate the program. This is a direct gap for a product sold primarily to buyers doing online research before purchasing.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero from 'Explore Math And Find the adventure of a Lifetime' to lead with our back-to-school bundle offer",
  ...
  },
  {
    id: "mcda-ccg-inc",
    company: "MCDA CCG, INC",
    logo: "/assets/reports/mcda-ccg-inc/logo.svg",
    logoNeedsBg: false,
    url: "https://mcdaccginc.com",
    ...
    opportunityFindings: [
      {
        label: "Speed promise vs. slow site",
        body: "MCDA CCG promises 'Strategy. Execution. Impact.' to clients navigating complexity. But when the marketing team needs to update a service page, add a case study, or test a new CTA, that promise is only as fast as whoever controls the Wix account. A consulting firm that can't move fast on its own site sends the wrong signal to every prospect who lands on it.",
      },
      {
        label: "Missing service-specific schema",
        body: "Only generic LocalBusiness schema is present with no service-specific markup, so the site misses rich result opportunities that would highlight their consulting specialties in search. Competitors with proper schema markup are more likely to appear prominently for the exact searches MCDA CCG should be winning.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero from 'Take Your Business to Higher Ground' to speak directly to our financial services clients",
  ...
  {
    id: "mega-global-education-group-inc",
    company: "Mega Global Education Group inc.",
    logo: "/assets/reports/mega-global-education-group-inc/logo.svg",
    logoNeedsBg: false,
    url: "https://megaglobaledu.com",
    ...
    opportunityFindings: [
      {
        label: "Personalization promise vs. slow updates",
        body: "Mega Global positions itself on individual attention — teaching based on individual aptitude. But when admissions cycles shift, new programs launch, or students ask about new offerings, a Wix site turns every update into a multi-day wait. When a student asks about a new program and the site is three weeks behind, that's a conversion they didn't get.",
      },
      {
        label: "Search snippet in the wrong language",
        body: "Without a meta description, search results default to raw page content that may not be in the prospect's language, making it difficult for international clients to understand what the service offers. This is a direct barrier for the multilingual audience Mega Global is targeting.",
      },
    ],
    aiExamples: {
      prompt1: "Add a new featured program page for our fall art study abroad cohort",
  ...
  },
  {
    id: "nanosilicon-inc",
    company: "NanoSILICON, Inc.",
    logo: "/assets/reports/nanosilicon-inc/logo.svg",
    logoNeedsBg: false,
    url: "https://nanosiliconinc.com",
    ...
    opportunityFindings: [
      {
        label: "Quality control gap on own site",
        body: "NanoSILICON's positioning is clear: what separates them from other silicon wafer suppliers is an intense focus on quality control. That standard should extend to the website — but WordPress makes every update a dependency chain, and the site ends up lagging behind the business. In a market where buyers evaluate suppliers on credibility, a stale site sends the wrong signal.",
      },
      {
        label: "Incorrect schema format",
        body: "The structured data uses a format Google may not parse correctly, which reduces the chance of rich results for this B2B silicon wafer supplier. Fixing this would directly improve how the company appears in searches from procurement teams and engineers evaluating suppliers.",
      },
    ],
    aiExamples: {
      prompt1: "Add a news post about our latest reclaim wafer quality benchmarks",
  ...
  {
    id: "nozomi-medalliance-k-k",
    company: "Nozomi MedAlliance K.K.",
    logo: "/assets/reports/nozomi-medalliance-k-k/logo.svg",
    logoNeedsBg: false,
    url: "https://nozomimed.com",
    industry: "MedTech / Medical Device Market Entry and Ecosystem Development (Japan)",
    pages: 5,
    hostingCost: 16,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Speed gap in a timing-driven business",
        body: "Nozomi MedAlliance sits at the intersection of global MedTech and the Japanese market. The business moves on relationships, timing, and credibility. A Wix site that takes days to update when a new portfolio company launches or a partnership announcement goes out is a gap between how fast the business moves and how fast the site can keep up.",
      },
      {
        label: "No MedTech search markup",
        body: "Only generic site-level schema is present with no Organization or Service markup, which limits how Google represents this MedTech consultancy in search results for healthcare and biotech audiences. Proper structured data would make the firm more visible to the international partners and founders they're trying to reach.",
      },
    ],
    aiExamples: {
      prompt1: "Add a new portfolio company to the Portfolio page with their overview and logo",
  ...
  {
    id: "o-m-g-entertainment",
    company: "O.M.G Entertainment",
    logo: "/assets/reports/o-m-g-entertainment/logo.svg",
    logoNeedsBg: false,
    url: "https://omgentertain.com",
    ...
    opportunityFindings: [
      {
        label: "Momentum lost to the queue",
        body: "O.M.G Entertainment's pitch is bold: innovative media marketing solutions to help brands disrupt and dominate. But when an event wraps, a new brand partner signs, or a campaign needs a dedicated landing page, a Wix site turns that momentum into a waiting game. In events and multicultural marketing, timing is everything.",
      },
      {
        label: "Schema points to wrong domain",
        body: "The schema points to a different domain, which signals inconsistency to Google and weakens the authority of the current domain in event searches. This technical mismatch actively works against the site's ability to rank in the multicultural marketing and events categories where O.M.G competes.",
      },
    ],
    aiExamples: {
      prompt1: "Add a recap page for last weekend's event with photos and brand logos",
  ...
  {
    id: "rome-real-estate-group",
    company: "ROME Real Estate Group",
    logo: "/assets/reports/rome-real-estate-group/logo.svg",
    logoNeedsBg: false,
    url: "https://romecre.com",
    industry: "Commercial Real Estate",
    pages: 13,
    ...
    opportunityFindings: [
      {
        label: "Stale listings cost credibility",
        body: "In commercial real estate, timing is everything — a stale listing page or an outdated team bio costs credibility. On WordPress, every update sits behind a designer or a plugin, and that lag is visible to clients. In a market where listings move fast, a website that moves slow is a liability.",
      },
      {
        label: "No social preview on shares",
        body: "The social sharing setup is missing both a description and a preview image, so when the site is shared on LinkedIn or in email, the link appears as a bare title with no context or visual. For a commercial real estate group that relies on professional networks, this directly reduces engagement from the right audience.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to say 'Building Relationships. Adding Value. Achieving Results.' — make it bolder and center it.",
  ...
  },
  {
    id: "rpn-ventures-llc",
    company: "RPN Ventures LLC",
    logo: "/assets/reports/rpn-ventures-llc/logo.svg",
    logoNeedsBg: false,
    url: "https://rpnventures.com",
    industry: "Business Consulting / Venture Advisory",
    pages: 6,
    ...
    opportunityFindings: [
      {
        label: "Pitch lands late",
        body: "RPN's positioning is sharp — 'Helping You Achieve Breakthrough Success' — but if updating the site to match a new pitch or proposal narrative takes days, the message lands late. WordPress means every change is a request, not an action. When the business is selling strategy and results, a website that can't keep pace with the thinking is working against the pitch.",
      },
      {
        label: "No social preview at all",
        body: "There are no Open Graph or Twitter Card tags at all, which means every link shared on social media or in email generates a blank preview with no description and no image. For a consulting firm that relies on referrals and LinkedIn presence, this is a missed impression every time the site is shared.",
      },
    ],
    aiExamples: {
      prompt1: "Rewrite the hero to focus on our Core Differentiators — pull the key phrase up to the top.",
  ...
  {
    id: "tech-inception-inc",
    company: "Tech Inception Inc.",
    logo: "/assets/reports/tech-inception-inc/logo.svg",
    logoNeedsBg: false,
    url: "https://techinception.com",
    industry: "Healthcare Technology / Geriatric Care",
    pages: 6,
    ...
    opportunityFindings: [
      {
        label: "Portfolio updates stuck in queue",
        body: "Tech Inception is transforming senior care through technology across pharmacy, hospice, diagnostics, and BPO. Every time a new portfolio company launches or a program shifts, updating the site becomes a project that goes through someone else's queue. When a new portfolio company goes live or a care program changes, the site should reflect it the same day.",
      },
      {
        label: "No social preview or meta description",
        body: "There are no social preview tags and no meta description, so the site has no control over how it appears when shared in email, LinkedIn, or messaging. For a healthcare technology firm building credibility with operators, investors, and partners, this gap in first impressions is a consistent liability.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to read 'Technology-Driven Geriatric Care — Pharmacy, Hospice, Diagnostics, and Beyond'",
      result1: "✓ Done in under 10 minutes, live immediately, no ticket filed",
      prompt2: "Add a Portfolio Companies page for our new diagnostic lab subsidiary with its own description and contact section",
      result2: "✓ Full page built and published same day — same design, new content, no dev cycle",
      prompt3: "Change the 'VIEW DETAIL' CTA on the Hospice section to 'Learn About Our Hospice Program'",
      result3: "✓ Updated instantly across the site, tested, live — no designer involved",
    },
  },
  {
    id: "the-air-show-network",
    company: "The Air Show Network",
    logo: "/assets/reports/the-air-show-network/logo.svg",
    logoNeedsBg: false,
    url: "https://airshownetwork.com",
    industry: "Air Show Production & Live Event Entertainment",
    pages: 13,
    ...
    opportunityFindings: [
      {
        label: "Live schedule can't wait on queues",
        body: "The Air Show Network produces 1,500+ shows across 47 states and Canada, with a live event schedule that changes constantly. Every new show date, sponsor update, or VIP experience detail that needs to go up on the site is a request waiting in someone's queue. With a live event schedule and sponsorship packages changing season to season, a site you can't touch yourself is a liability.",
      },
      {
        label: "No preview image on shares",
        body: "Without a preview image on LinkedIn or Facebook shares, links to the site show up as plain text — potential clients scrolling their feed are less likely to click through. For a live events company that relies on professional relationships and sponsorships, every missed impression in a feed is a missed connection.",
      },
    ],
    aiExamples: {
      prompt1: "Add the 2026 air show schedule to the Air Show Schedule page with dates, locations, and links",
  ...
  {
    id: "the-sharpe-alliance",
    company: "THE SHARPE ALLIANCE",
    logo: "/assets/reports/the-sharpe-alliance/logo.svg",
    logoNeedsBg: false,
    url: "https://sharpealliance.com",
    industry: "Marketing, Branding & Sponsorship / Strategic Partnerships",
    pages: 8,
    ...
    opportunityFindings: [
      {
        label: "Client wins go live too slowly",
        body: "THE SHARPE ALLIANCE has driven $30MM+ in revenue and served 500+ clients across corporate sponsorships, brand building, live media, and event production. Every new client win, campaign result, or service update that needs to go on the site is a project — not a five-minute edit. A strategic partnerships firm that moves fast for clients shouldn't be bottlenecked by its own website platform.",
      },
      {
        label: "No preview image on shares",
        body: "The social preview setup is missing an image entirely, so when this site is shared, no image appears alongside the link — making it less likely anyone clicks through. For a firm that wins business through reputation and referrals, every share without a visual is a weaker first impression.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero headline to 'Create Connections. Accelerate Business. $30MM+ in Results.' and add a client logo row below it",
  ...
  {
    id: "tmp-metals-group-ltd",
    company: "TMP Metals Group, Ltd.",
    logo: "/assets/reports/tmp-metals-group-ltd/logo.svg",
    logoNeedsBg: false,
    url: "https://tmpmetalsgroup.com",
    ...
    opportunityFindings: [
      {
        label: "Message misses the market window",
        body: "In commodities trading, timing is credibility. When markets shift, the site should reflect that the same day — not after a designer queue clears. Right now, every update to hero copy, sourcing regions, or industry focus goes through someone else first. In metals trading, a message that's three days late is a message that missed the moment.",
      },
      {
        label: "No social preview or meta description",
        body: "There are no Open Graph or Twitter Card tags and no meta description, meaning any link to this metals trading company shared in a business context shows up as a bare URL with no description or image. For a firm building credibility with buyers and partners in a high-trust industry, this is a persistent gap.",
      },
    ],
    aiExamples: {
      prompt1: "Update our hero to lead with tokenization — move the refining and distribution language below the fold.",
  ...
  {
    id: "uwc-private-equity-group",
    company: "UWC Private Equity Group",
    logo: "/assets/reports/uwc-private-equity-group/logo.svg",
    logoNeedsBg: false,
    url: "https://uwcpeg.com",
    ...
    opportunityFindings: [
      {
        label: "Trust requires a current site",
        body: "Investment management is trust-driven, and the site is how credibility is established before anyone picks up the phone. When a new fund closes, a partnership forms, or the AI lead gen positioning needs to sharpen, the update needs to happen that day — not after waiting on a platform that caps what you can do. In private equity, the site is often the first credibility check.",
      },
      {
        label: "No FinancialService schema",
        body: "The site has only a generic site-level tag with no Organization or FinancialService schema, so search engines can't surface rich results when investors search for private equity firms. Adding proper structured data would directly improve visibility among the high-intent audience UWC is targeting.",
      },
    ],
    aiExamples: {
      prompt1: "Rewrite the hero to lead with a single clear line — something like 'Strategic Capital. Delivered.' — instead of listing all seven business lines.",
  ...
  {
    id: "watermark-worldwide-llc",
    company: "Watermark Worldwide, LLC",
    logo: "/assets/reports/watermark-worldwide-llc/logo.svg",
    logoNeedsBg: false,
    url: "https://watermarkww.com",
    industry: "Entertainment, Esports & Brand Partnership Marketing",
    pages: 5,
    ...
    opportunityFindings: [
      {
        label: "Partnership windows are short",
        body: "In esports and entertainment, the window on a partnership opportunity is short. When a new property comes in or a brand activation wraps and needs to be showcased, the site needs to reflect that immediately. On WordPress, that update has to go through someone else before it's live — friction that a firm selling its own marketing expertise shouldn't be carrying.",
      },
      {
        label: "No social preview or meta description",
        body: "There are no social preview tags at all and no meta description, so this brand marketing agency has no control over how its site appears when shared — a visible gap for a firm selling its own marketing expertise. Every link shared in a professional context renders as a bare URL with no visual or description.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to call out our esports and video game specialization more directly — right now it's buried below 'WE CONNECT ENTERTAINMENT PROPERTIES AND BRANDS.'",
  ...
  },
  {
    ...
    logo: "/assets/reports/atlas-gray-llc/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "Platform controls the message",
        body: "Atlas Gray coaches leaders and athletes to stop letting external systems control their outcomes. The Wix site is doing exactly that — putting a designer or platform between the founder and her own message. In a relationship-driven practice, the site needs to move as fast as the thinking, not on a platform's terms.",
      },
      {
        label: "No consulting business schema",
        body: "The site has no structured data identifying it as a consulting business, which reduces its chances of appearing in service-specific search results. Without schema, search engines treat this as a plain page and miss the opportunity to surface it for leadership coaching and mindset consulting searches.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to 'We work with leaders and athletes to make mindset the competitive edge — not an afterthought.'",
      result1: "✓ Hero updated and live in minutes — no Wix editor, no waiting on a designer.",
      prompt2: "Add a new page for Management Training with a 'Book a Call' CTA matching the existing design.",
      result2: "✓ Page built, reviewed, and published same day — layout matches the rest of the site automatically.",
      prompt3: "Change 'Book a Call' to 'Start the Conversation' and test if that reduces friction for new visitors.",
      result3: "✓ Updated instantly. Revert or try a third option anytime — fully in your control.",
    },
  },
  {
    id: "carlisle-energy-solutions-inc",
    company: "CARLISLE ENERGY SOLUTIONS INC",
    logo: "/assets/reports/carlisle-energy-solutions-inc/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "Utility programs move faster than WordPress",
        body: "Carlisle Energy's value is in saving refrigerated warehouses real money through programs most operators don't know exist. When those programs update, or a new product line becomes available, that information needs to be live immediately — not after a WordPress update cycle. New products and utility programs move fast — a site that can't reflect them immediately costs leads that go to competitors who look more current.",
      },
      {
        label: "No preview image on shares",
        body: "The site is missing a social preview image, so links shared in professional networks render without a visual — even though the work itself produces quantifiable results that a strong image could reinforce. For a firm winning business through referrals and professional outreach, this is a consistent first impression gap.",
      },
    ],
    aiExamples: {
      prompt1: "Add a new product to 'Cold Solutions Products' — the new EC motor line we just started distributing",
      result1: "✓ New product listed same day with specs, images, and a contact CTA — no plugin, no ticket",
      prompt2: "Update 'Our Energy Saving Services' to lead with the utility incentive rebate angle — that's what's closing deals right now",
      result2: "✓ Copy updated in minutes, before the next prospect visits the page",
      prompt3: "Add a Temperature Reporting case study showing the ROI a produce warehouse saw after 90 days",
      result3: "✓ New case study page live same day — draft it in plain language, AI formats it, you approve and ship",
    },
  },
  {
    id: "cartegrity-llc",
    company: "CARtegrity LLC",
    logo: "/assets/reports/cartegrity-llc/logo.svg",
    logoNeedsBg: false,
    url: "https://cartegrity.com",
    ...
    opportunityFindings: [
      {
        label: "Trust pitch needs to match speed",
        body: "CARtegrity's pitch is personal and trust-driven. When they want to update how the process is explained, add a new testimonial, or test a different opening line, that should take 10 minutes — not a designer conversation. In a concierge service built on trust, site copy needs to match the exact language that's working in real conversations.",
      },
      {
        label: "No social preview image",
        body: "Without a social preview image, shares of this car-buying concierge service show no visual — reducing the likelihood that referrals passed through social channels convert into first visits. For a service that relies heavily on word-of-mouth, every shared link without an image is a weaker referral.",
      },
    ],
    aiExamples: {
      prompt1: "Change 'Get Started!' to 'Schedule Your Free Discovery Call' everywhere on the site",
      result1: "✓ Updated across all 6 pages in minutes — consistent, on-brand, no designer needed",
      prompt2: "Add a new bullet under 'What You Gain Working With Us' — something about avoiding dealer pressure tactics",
      result2: "✓ Added and live immediately, matching the existing layout and formatting",
      prompt3: "I want to test a version of 'Here's How It Works' that leads with the money saved, not the process steps",
      result3: "✓ Reordered, published, and trackable — swap back anytime if it doesn't convert",
    },
  },
  {
    id: "dak-consulting-group",
    company: "Dak Consulting Group",
    logo: "/assets/reports/dak-consulting-group/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "Speed claim vs. slow site",
        body: "DCG's positioning is specific and credible: finance and accounting consulting built around 'rapid, seamless solutions.' But when messaging shifts — a new service, a new client win, a new CTA — the site lags behind because every edit requires someone else's time. For a firm where the pitch is speed, a slow-moving website sends the wrong signal to the exact clients being targeted.",
      },
      {
        label: "Missing preview image and domain inconsistency",
        body: "The social preview image is absent, and the site also redirects from a different domain, which can confuse referral traffic and signals inconsistency to search engines. Both issues work against the credibility a finance consulting firm needs to establish in the first seconds with a new prospect.",
      },
    ],
    aiExamples: {
      prompt1: "Change the hero to: 'Finance and accounting consulting built for speed — interim roles filled in days, not weeks.'",
      result1: "✓ Updated live in minutes, no designer needed, no queue",
      prompt2: "Add a new section under Recruiting Solutions for retained search — same style as the Consulting Solutions block",
      result2: "✓ New section built and live same day, matching the existing design exactly",
      prompt3: "Update 'Get in Touch' to 'Talk to Dak' and point it to the contact form",
      result3: "✓ CTA updated across every page in one edit, no dev required",
    },
  },
  {
    id: "dandelion-global-llc",
    company: "Dandelion Global LLC",
    logo: "/assets/reports/dandelion-global-llc/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "Story gets stuck in the queue",
        body: "Dandelion Global's positioning is sharp: bridging businesses to Asia's markets through strategic precision. But the moment that story evolves — a new client win, a new geography, a refined service offering — the site is stuck waiting for someone else to update it. When positioning yourself as a gateway to Asia's business landscape, a site that can't move quickly undercuts the very agility being sold.",
      },
      {
        label: "Blurry preview image on LinkedIn",
        body: "The social preview image uses a 150x150 pixel logo — far below the recommended size — meaning it appears blurry or cropped on LinkedIn and Facebook, weakening the first impression during outreach. For a firm that does much of its business development through professional networks, this is a visible credibility gap.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero subheading to mention Southeast Asia expansion — keep the same tone as 'Bridging Extraordinary Businesses to Global Markets'",
      result1: "✓ Live in minutes, voice and layout unchanged",
      prompt2: "Add a new case study card under 'Our works' — same format as the existing ones",
      result2: "✓ New work entry added same day without touching a single line of code",
      prompt3: "Change 'Schedule now' to 'Book a Strategy Call' and link it to my Calendly",
      result3: "✓ CTA updated sitewide, pointing to the right link, no developer required",
    },
  },
  {
    id: "deal-synergy-solutions-llc",
    company: "Deal Synergy Solutions LLC",
    logo: "/assets/reports/deal-synergy-solutions-llc/logo.svg",
    logoNeedsBg: false,
    url: "https://dealsynergysolutions.com",
    ...
    opportunityFindings: [
      {
        label: "M&A windows don't wait for queues",
        body: "Deal Synergy Solutions has a clear thesis: 'The Art of the Possible' through acquisitions and investments. With 19 pages serving strategic acquirers, PE firms, and roll-up strategists, the site has real depth. But depth becomes a liability the moment messaging needs updating, a new client segment needs to be added, or a CTA needs to move — and every change requires going back through a designer or platform. In M&A, the positioning window is narrow.",
      },
      {
        label: "No LinkedIn preview image",
        body: "No social preview image is set, meaning every time this M&A advisory firm is shared on LinkedIn — where their core audience lives — the link renders without a visual and loses impact. For a firm trying to establish credibility with PE professionals and strategic acquirers, this is a recurring missed impression.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to lead with 'Inorganic growth advisory for strategic acquirers and PE firms' — keep the 'Art of the Possible' framing below it",
      result1: "✓ Hero updated live in minutes, existing structure preserved",
      prompt2: "Add a new page for our roll-up growth practice — same layout as the Strategic Acquirers page",
      result2: "✓ New page built and live same day, no design brief needed",
      prompt3: "Change 'Free Consultation' to 'Start Your Inorganic Growth Journey' on the homepage and service pages",
      result3: "✓ CTA updated across all relevant pages at once, no developer required",
    },
  },
  {
    id: "emery-power-llc",
    company: "Emery Power LLC",
    logo: "/assets/reports/emery-power-llc/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "EV market moves faster than Wix",
        body: "EV infrastructure and energy storage are evolving faster than any designer's turnaround time. When service scope needs updating, a new technology area needs to be added, or a client question needs a fresh page, the ability to move same-day matters. In a sector where vendor rosters shift and new procurement opportunities appear quickly, content that lags behind the market costs deals.",
      },
      {
        label: "Wrong page title in search",
        body: "No meta description is set, and the homepage title shows 'About' instead of the company name — so search engines may rank the wrong page and display unhelpful snippets to anyone searching for energy consulting services. This is a direct hit on discoverability for the utility companies and procurement teams Emery Power is trying to reach.",
      },
    ],
    aiExamples: {
      prompt1: "Add Vendor Validation as a standalone service page under Procurement & Sourcing with a case study section.",
      result1: "✓ Page built and live same day — no brief, no back-and-forth",
      prompt2: "Update the hero from 'Your Stepping Stone for a Better Future' to speak directly to utility companies evaluating energy storage.",
      result2: "✓ Live in minutes, no designer needed",
      prompt3: "Add a Careers page with our current open roles and a simple application form.",
      result3: "✓ Built, linked to nav, and accepting submissions before end of day",
    },
  },
  {
    id: "evergold-consulting-llc",
    company: "Evergold Consulting LLC",
    logo: "/assets/reports/evergold-consulting-llc/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "Financial rigor should extend to the site",
        body: "When advising clients on financial rigor, own operations need to model that standard. A site that requires a designer to update the Month Close offering, add a new Systems integration partner, or refresh CFO services is an ops gap hiding in plain sight. For a firm with four distinct service lines, keeping each page current and specific is table stakes for converting a qualified visitor.",
      },
      {
        label: "Low-context search snippet",
        body: "Without a meta description, Google writes the search snippet itself, usually pulling a low-context phrase from the page, which reduces clicks from finance executives searching for fractional CFO services. In a high-trust, niche professional services category, the search result is often the first filter a prospect applies.",
      },
    ],
    aiExamples: {
      prompt1: "Update the Month Close page to highlight our new KPI tracking and variance reporting add-ons as featured offerings.",
      result1: "✓ Live in minutes — no designer, no back-and-forth",
      prompt2: "Add a landing page for early-stage companies that need bookkeeping and a monthly financial reporting package to get investor-ready.",
      result2: "✓ AI drafts it from your brief, you review, ships same day",
      prompt3: "Change the 'Get In Touch' CTA on the CFO page to 'Book a Free Discovery Call' with a calendar link.",
      result3: "✓ Updated across the page in one edit",
    },
  },
  {
    id: "farr-johnen-associates",
    company: "Farr Johnen & Associates",
    logo: "/assets/reports/farr-johnen-associates/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "Pre-call research has to show confidence",
        body: "If a prospect books a consultation and then checks the site again before the call, what they find needs to be current, confident, and clear. Stale copy or an outdated service description undermines the relationship before it starts. For an advisory practice built on a customized process, the site should reflect that precision.",
      },
      {
        label: "Uncontrolled search snippet",
        body: "Without a meta description, Google writes its own snippet for search results — often pulling generic page text rather than the firm's actual positioning. In insurance advisory, where prospects are comparing multiple firms before reaching out, a vague search snippet is a missed opportunity to differentiate.",
      },
    ],
    aiExamples: {
      prompt1: "Change the hero tagline from 'It's All About Service' to include a line about our employer benefits specialty.",
      result1: "✓ Updated live in minutes — no Wix editor login required, no support ticket",
      prompt2: "Add a step to Our Customized Process that explains how we handle annual benefits reviews.",
      result2: "✓ New process step added to the page, formatted to match the existing layout",
      prompt3: "The Schedule A Consultation button should go to our new Calendly link — swap it out.",
      result3: "✓ CTA link updated immediately, tested and verified before you close the tab",
    },
  },
  {
    id: "flight-effect-llc",
    company: "Flight Effect LLC",
    logo: "/assets/reports/flight-effect-llc/logo.svg",
    logoNeedsBg: false,
    url: "https://flighteffect.com",
    ...
    opportunityFindings: [
      {
        label: "Yesterday's story won't close today's deal",
        body: "When closing brand deals in gaming, lifestyle, and entertainment, the site needs to reflect the current roster and positioning. Waiting days to update a client logo or swap a case study headline is friction that can't be afforded when selling speed and impact. For an agency that sells brand elevation, the own brand's site needs to be as fast and sharp as the work delivered for clients.",
      },
      {
        label: "No meta description for search results",
        body: "Without a meta description, search results show whatever text Google pulls from the page, which doesn't give potential clients a clear reason to click. In a competitive agency market where prospects are evaluating multiple firms from search, a weak search snippet is a consistent missed opportunity.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero from 'MARKETING EVOLVED' to include our new tagline about gaming and entertainment brand strategy.",
      result1: "✓ Hero copy updated and live in under 10 minutes, no Wix editor needed",
      prompt2: "Add two new logos to the Brands We Work With section — here are the image files.",
      result2: "✓ Logos uploaded and added to the section immediately, no design ticket required",
      prompt3: "The Flight Effect Way section needs a new bullet that covers our events and experiential partnerships.",
      result3: "✓ New content added and formatted to match the existing section, published same day",
    },
  },
  {
    id: "h-s-insights",
    company: "H&S Insights",
    logo: "/assets/reports/h-s-insights/logo.svg",
    logoNeedsBg: false,
    url: "https://hsinsights.com",
    ...
    opportunityFindings: [
      {
        label: "Procurement reviews require a current site",
        body: "When a procurement team or agency partner reviews capabilities before a contract, the site has to reflect exactly what the firm does and why it's the right choice. If innovation management or energy consulting offerings need updating and the team is waiting on a developer, that opportunity doesn't wait with them. A firm built around PROPELling innovation shouldn't have a website that moves at a crawl.",
      },
      {
        label: "Uncontrolled search snippet",
        body: "Without a meta description, Google writes its own snippet — often pulling unrepresentative page text — which reduces click-through for anyone searching for market research services. For a women and minority-owned firm where the website is often the first credential check, the search snippet is a critical first impression.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero tagline — change 'Empowering now for tomorrow' to reflect our new energy consulting focus.",
      result1: "✓ Hero updated and live in minutes, no Wix editor required",
      prompt2: "Add a capabilities overview under Innovation Management that outlines our process for federal and municipal clients.",
      result2: "✓ New content section added and formatted to match your site, published same day",
      prompt3: "The Learn More button should link to our updated services page — swap the destination.",
      result3: "✓ CTA updated immediately, tested before you close the tab",
    },
  },
  {
    id: "hill-search-solutions-llc",
    company: "Hill Search Solutions LLC",
    logo: "/assets/reports/hill-search-solutions-llc/logo.svg",
    logoNeedsBg: false,
    url: "https://hillsearchsolutions.com",
    industry: "Executive Search & Staffing",
    pages: 5,
    ...
    opportunityFindings: [
      {
        label: "Placement windows are short",
        body: "Hill Search Solutions runs on relationships and speed — the firms that place talent first win. When the site takes days to update a new industry vertical, a new service offering, or a seasonal 'we're actively hiring' push, the firm is slower than it needs to be. In recruiting, the window to capture a candidate or client is short — a site that can't keep up costs placements.",
      },
      {
        label: "No preview image on LinkedIn",
        body: "The social preview image is missing, so shared links on LinkedIn and other platforms appear without a thumbnail — which hurts credibility when recruiters or employers share the site. For a staffing firm that does active business development through professional networks, this is a visible gap.",
      },
    ],
    aiExamples: {
      prompt1: "Change the hero from 'FRESH TALENT! TOP COMPANIES!!!' to something that leads with our specialty industries — accounting, tech, and construction.",
      result1: "✓ Hero copy updated and live in under 10 minutes, no designer required",
      prompt2: "Add a new section under 'For Companies' that calls out our process — extensive and precise — with a direct 'Start a Search' CTA.",
      result2: "✓ New section built and published same day, using your own words from the site",
      prompt3: "I want to test whether 'FIND TALENT' or 'Start Hiring Now' gets more clicks on the homepage.",
      result3: "✓ Swap the CTA, monitor it, revert or keep — all without touching a developer",
    },
  },
  {
    id: "jorian-hoover-startup-fundraising",
    company: "Jorian Hoover Startup Fundraising",
    logo: "/assets/reports/jorian-hoover-startup-fundraising/logo.svg",
    logoNeedsBg: false,
    url: "https://jorianhoover.com",
    ...
    opportunityFindings: [
      {
        label: "Fundraise urgency needs a fast site",
        body: "Founders come to Jorian Hoover because their raise window is short and the stakes are high. A site that takes days to update can't keep pace with new offers, client wins, or timely messaging — and that friction shows up in conversion. When clients are racing against fundraising timelines, the own site shouldn't be stuck in one.",
      },
      {
        label: "No structured data for coaching searches",
        body: "Without structured data, search engines can't identify the type of coaching or advisory work offered here — limiting the chances of appearing in relevant professional searches. For a coaching practice targeting founders at a specific stage, structured markup would directly improve visibility to the right audience.",
      },
    ],
    aiExamples: {
      prompt1: "Update 'Are you prepared for your fundraise?' — I want to test a version that speaks directly to pre-seed founders",
      result1: "✓ New hero live in minutes, old version saved to revert if needed",
      prompt2: "Add a landing page for my Custom-Built Blueprint offer — same feel as the existing site, with a short application form",
      result2: "✓ New page built and live same day, form ready to capture leads",
      prompt3: "Change the CTA from 'apply for call' to something that signals more urgency — want to test two options",
      result3: "✓ Both versions testable immediately, no dev involvement required",
    },
  },
  {
    id: "kremer-leadership-institute",
    company: "Kremer Leadership Institute",
    logo: "/assets/reports/kremer-leadership-institute/logo.svg",
    logoNeedsBg: false,
    url: "https://kremerleadership.com",
    industry: "Business Coaching & Consulting (Dental Practices)",
    pages: 9,
    hostingCost: 16,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Operational excellence starts with the site",
        body: "Kremer Leadership Institute coaches dental practices on management, operations, and growth. When the site falls behind — outdated offers, stale copy, no way to test what's working — it signals the opposite of the operational excellence being sold. A coaching firm with 20+ years of industry experience shouldn't be waiting on a platform or a designer to tell its own story.",
      },
      {
        label: "Uncontrolled search snippet",
        body: "Without a meta description, the search result snippet is pulled from random page copy, making it harder to attract the right clients from search. For a practice-specific coaching firm, the search snippet is often the first filter a dental practice owner applies when evaluating their options.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero tagline — 'Knowing. Leading. Inspiring.' feels too vague, I want something that speaks directly to dental practice owners",
      result1: "✓ New copy live in minutes, no ticket filed, no designer loop",
      prompt2: "Add a new page for our practice acquisition consulting service — same structure as the What We Do section",
      result2: "✓ New page built and published same day with your existing design",
      prompt3: "The contact form isn't converting — I want to test replacing the generic Submit button with something more specific to our intake",
      result3: "✓ New CTA live immediately, revertable anytime",
    },
  },
  {
    id: "lennon-management-inc",
    company: "Lennon Management Inc.",
    logo: "/assets/reports/lennon-management-inc/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "Creator economy moves by the day",
        body: "Lennon Management has been building creator careers for 10 years. In an industry where relevance is measured in days, not quarters, a site that requires a designer queue to update a roster or add a campaign case study is a liability. When a brand deal closes or a new creator joins the roster, the site should reflect that today — not next week after a designer gets to it.",
      },
      {
        label: "Site is invisible to search",
        body: "The site currently returns a connection error with noindex set, meaning it doesn't appear in search results at all. This is a complete gap for a talent management firm that should be discoverable by brands, creators, and industry professionals searching for management services.",
      },
    ],
    aiExamples: {
      prompt1: "Add a new creator to the talent roster under Talent Management — here's their bio and photo",
      result1: "✓ Roster updated and live in minutes, no designer required",
      prompt2: "We just wrapped a major Influencer Marketing campaign — I want to add it as a case study with results",
      result2: "✓ New case study page built same day, matching your existing layout",
      prompt3: "Update the hero from '10 years of Lennon Management' to something that speaks to brands looking to book talent",
      result3: "✓ New hero copy live immediately, old version preserved if you want to revert",
    },
  },
  {
    id: "living-motions-management-marketing",
    company: "Living Motions Management Marketing",
    logo: "/assets/reports/living-motions-management-marketing/logo.svg",
    logoNeedsBg: false,
    ...
    opportunityFindings: [
      {
        label: "The pitch contradicts the process",
        body: "Living Motions positions itself as the solution to creator burnout and platform friction. The irony is that every time the site needs a change — a new service, a sharper offer, a fresh CTA — it goes into a queue that looks a lot like the problem being solved for clients. In an industry that moves at the speed of an algorithm update, a site stuck behind a designer is a growth bottleneck the firm doesn't need.",
      },
      {
        label: "Uncontrolled search snippet",
        body: "Without a meta description, Google pulls whatever text it finds on the page, which often makes the search result look incomplete and drives fewer clicks. For a firm targeting creators who discover new tools through search and social, a weak search snippet directly impacts top-of-funnel traffic.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero — 'For influencers who are done being the overworked middle man' is good but I want to A/B test a version that leads with the outcome",
      result1: "✓ Both versions live immediately, switchable without touching any code",
      prompt2: "Add a new service page for Voice-Aligned Content Writing — same structure as the existing services, with a short inquiry form",
      result2: "✓ New page built and live same day, form embedded and ready",
      prompt3: "The 'More Money. Higher Engagement. More Off Your Plate.' line is working — I want to build a dedicated landing page around it for paid traffic",
      result3: "✓ Standalone landing page live same day, built to match your brand",
    },
  },
  {
    id: "moore-valuation-consulting",
    company: "Moore Valuation & Consulting",
    logo: "/assets/reports/moore-valuation-consulting/logo.svg",
    logoNeedsBg: false,
    url: "https://mooreval.com",
    industry: "Commercial Real Estate Appraisal & Consulting",
    pages: 5,
    ...
    opportunityFindings: [
      {
        label: "Reputation requires a current site",
        body: "Boutique firms win on reputation — but a slow website erases that edge fast. When a prospective client lands on the site, credibility needs to be immediate. Right now, every update to projects, services, or positioning requires going back through Wix — and that delay costs. In a relationship-driven business like commercial real estate appraisal, the site needs to reflect new work and new positioning the moment it happens.",
      },
      {
        label: "No preview image on LinkedIn shares",
        body: "The social preview image is absent, so sharing a link to this commercial appraisal firm on LinkedIn or email produces a text-only preview with no visual, reducing trust and click-through. For a boutique firm that depends on professional referrals and LinkedIn presence, this is a consistent first impression gap.",
      },
    ],
    aiExamples: {
      prompt1: "Add a recent project to the Projects page — multifamily portfolio in the East Bay, completed last month.",
  ...
  {
    id: "affinity-shipping",
    company: "Affinity Shipping (USA) Inc.",
    logo: "/assets/reports/affinity-shipping/logo.svg",
    logoNeedsBg: false,
    url: "https://aftyusa.com",
    ...
    opportunityFindings: [
      {
        label: "No structured category signal",
        body: "Search engines see a Wix site, not a freight forwarding company. Affinity Shipping has no structured data telling Google what services it offers or what industry it operates in. Importers comparing forwarders in search results this week land on generic results — not a labeled one.",
      },
      {
        label: "Delayed capability updates cost deals",
        body: "When a new trade lane goes live or a supply chain disruption creates demand, the site can't reflect it until after a Wix editor session and mobile formatting fix. A new Southeast Asia lane or China-to-US ocean freight page that could win the next client takes weeks to go live instead of the same day.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero — replace the welcome text with 'Full-Range Freight Forwarding for US Importers. Ocean, Air, and Supply Chain Management.'",
      result1: "✓ Live today. Importers searching for a forwarder land on a page that speaks directly to their need — not a generic welcome message.",
      prompt2: "Add a 'Get a Quote' button to every page — I want it in the header, not just at the bottom of Contact Us.",
      result2: "✓ Done in one conversation. Every importer who lands anywhere on the site has an immediate path to reach out, not just the ones who scroll to the end.",
      prompt3: "Update 'About Affinity' to include our new Southeast Asia lane — same section, just updated copy and a route map.",
      result3: "✓ The capability that expands your addressable market is on the site the day it's operational, not three weeks after you asked.",
    },
  },
  {
    id: "black-iron-development",
    company: "Black Iron Development",
    logo: "/assets/reports/black-iron-development/logo.svg",
    logoNeedsBg: false,
    url: "https://blackirondevelopment.com",
    industry: "Real estate development — luxury residential and resort-branded residences",
    pages: 12,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "No structured project or location signal",
        body: "Google can't identify Black Iron Development's projects, locations, or property types from the site. Without structured data, the firm may not surface for investors and buyers actively scoping a luxury developer in Southern California. The search that would have led to a call closes before the site registers as relevant.",
      },
      {
        label: "Stale project pages cost credibility",
        body: "When a project hits a milestone — groundbreaking, pre-sales, completion — the site can't reflect it until after a designer queue. Investors visiting during that window see outdated information at exactly the moment timing matters most. A Caribbean Resort Branded Residences page that could capture international buyer searches remains unbuilt for weeks.",
      },
    ],
    aiExamples: {
      prompt1: "Update Current Projects to add the latest rendering and current phase status for each active development",
      result1: "✓ Investors visiting the site see current, credible information — which is the difference between a follow-up call and a pass.",
      prompt2: "Add a standalone page for Caribbean Resort Branded Residences with the project overview, location, and what makes it a branded residence opportunity",
      result2: "✓ International buyers and capital partners searching specifically for resort-branded residences now have a page that speaks directly to what they're looking for.",
      prompt3: "Rewrite the hero so it leads with the property types and geography — 'Luxury Homes, Condominiums, and Resort Residences in Southern California and the Caribbean' — and add a link to Current Projects",
      result3: "✓ The headline now matches what buyers and investors are actually searching for, and gives them a clear path to see what's available.",
    },
  },
  {
    id: "current-communications",
    company: "Current Communications",
    logo: "/assets/reports/current-communications/logo.svg",
    logoNeedsBg: false,
    url: "https://currentcomms.com",
    industry: "Beauty industry public relations",
    pages: 8,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Google writes their search snippet",
        body: "Current Communications has no meta description, so Google writes its own search result snippet. A beauty brand founder comparing PR agencies sees whatever Google decided to pull — not the positioning Colleen would choose. The agency's first impression in search results is written by an algorithm, not by the people who built it.",
      },
      {
        label: "Campaign wins can't update in time",
        body: "When a major beauty campaign lands, the site can't reflect it until after a designer queue that outlasts the momentum. The win that would close the next client stays off the site for weeks, and prospective brands read outdated service descriptions while the opportunity fades.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero so it leads with a specific result — 'PR for beauty brands that earns real coverage' — and add a direct link to Let's Work Together",
      result1: "✓ The headline now attracts the founder who already knows they want results-focused PR, and gives them a clear next step the moment they land.",
      prompt2: "Add a short section under Media Relations that names two or three publication types you regularly place clients in — beauty trade, lifestyle, consumer press",
      result2: "✓ Beauty brand founders can immediately see whether you've placed clients where they want to be — which makes the decision to reach out much shorter.",
      prompt3: "Write a meta description that says exactly what Current Comms does — creative PR for beauty brands, media relations, influencer campaigns, events — so Google shows our words in search, not its own guess",
      result3: "✓ The agency controls its first impression in every search result going forward — the snippet becomes an active pitch to the right buyer, not a generic placeholder.",
    },
  },
  {
    id: "custom-promotional-communications",
    company: "Custom Promotional Communications",
    logo: "/assets/reports/custom-promotional-communications/logo.svg",
    logoNeedsBg: false,
    url: "https://cpcmedia.com",
    industry: "Live chat services and inbound live operator communications",
    pages: 6,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Google controls the search snippet",
        body: "CPC has no meta description, so Google writes its own description in search results. Businesses comparing live chat providers see whatever Google decided to pull — not the message Jeff would choose. The first impression in search results is out of CPC's hands entirely.",
      },
      {
        label: "Voice broadcasting has no dedicated page",
        body: "Businesses searching specifically for voice broadcasting or automated calling land on a shared services page instead of a dedicated surface built for their need. A standalone page for this service would give CPC its own SEO ranking opportunity and stop potential customers from self-selecting out before they reach out.",
      },
    ],
    aiExamples: {
      prompt1: "Rewrite the hero so it leads with what makes CPC different — operators available 24/7, real people not bots, response times under 30 seconds",
      result1: "✓ The headline now filters for the buyers who care about quality over price — and gives them a reason to stay on the page instead of clicking back.",
      prompt2: "Give Inbound Live Operators and Live Chat Service their own dedicated sections with a short description of what's included and who it's for",
      result2: "✓ Each service now has a clear home that can rank on its own — a business searching for inbound operators specifically finds a page that speaks directly to them.",
      prompt3: "Add a meta description that says exactly what CPC does — live chat, inbound operators, voice broadcasting — so Google shows our words in search results, not its own guess",
      result3: "✓ CPC controls its first impression in every search result going forward — the snippet now works as a conversion tool, not an afterthought.",
    },
  },
  {
    id: "edge-audio-labs",
    company: "Edge Audio Labs",
    logo: "/assets/reports/edge-audio-labs/logo.svg",
    logoNeedsBg: false,
    url: "https://edgeaudiolabs.com",
    industry: "Audio software development / plugin engineering",
    pages: 6,
    hostingCost: 72,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Success stories can't update on launch day",
        body: "When a plugin ships, adding it to Success Stories requires a Webflow CMS edit and designer review — which means the proof point that closes the next studio client sits in a Slack message, not on the site. Audio companies and game studios evaluating partners mid-RFP compare portfolios that move; Edge Audio Labs' can't keep pace.",
      },
      {
        label: "Fastest-growing service is buried",
        body: "AI Audio Pipelines is the fastest-growing service line but it's listed third in the What We Do section, giving it no dedicated SEO surface and no conversion priority. A standalone landing page for this category would capture growing search demand and give paid traffic a dedicated destination.",
      },
    ],
    aiExamples: {
      prompt1: "Add the new synthesizer plugin to Success Stories — same layout as the others, with the client name, what we built, and the launch outcome.",
      result1: "✓ Live the day the plugin ships. The case study that closes the next studio client is on the site while the launch is still news, not three weeks after.",
      prompt2: "Update 'What We Do' to put AI Audio Pipelines first — it's becoming our fastest-growing service line and it's buried third.",
      result2: "✓ Done in one conversation. The service category with the most demand is the first thing a studio sees when they land on the page.",
      prompt3: "Add a new page for MVP Creation — I want it to have its own URL so we can run paid traffic to it.",
      result3: "✓ New page is live same day. The service that converts fastest gets its own conversion surface, not just a section on a shared page.",
    },
  },
  {
    id: "global-connects-media",
    company: "Global Connects Media",
    logo: "/assets/reports/global-connects-media/logo.svg",
    logoNeedsBg: false,
    url: "https://globalconnects.media",
    industry: "Entertainment consulting and Japan-US media partnerships",
    pages: 8,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "No structured consultancy signal for search",
        body: "Google can't fully identify Global Connects as a media consultancy — the site is missing structured data that tells search engines what services are offered and what market is served. Studios in Los Angeles exploring Japan-US distribution partnerships may not find the firm at all during their active research window.",
      },
      {
        label: "No case studies to convert curious studios",
        body: "The Brands We've Worked With section describes what Global Connects does but offers no evidence of past deals or outcomes. A prospective studio client sees no proof of completed work and moves on. The site needs to go from describing capabilities to proving them — which is what turns a curious studio into a call.",
      },
    ],
    aiExamples: {
      prompt1: "Update the Services section to give each offering — Research, Agency, Product Development, Business Seminar, Publicity — its own short description that speaks to studios specifically",
      result1: "✓ Each service is now findable and readable on its own terms — a studio scoping a specific type of help lands on language that matches what they're looking for.",
      prompt2: "Add a short section under Global Connects Mission that names the Japan-US market specifically and what kind of partners you work with",
      result2: "✓ The mission statement now works as a filter — studios who are the right fit recognize themselves, and those who aren't self-select out.",
      prompt3: "Build a simple project or client page that shows one or two completed partnerships — what the brief was, what you delivered",
      result3: "✓ The site goes from describing what you do to proving it — which is the thing that turns a curious studio into a call.",
    },
  },
  {
    id: "kimpton-ai",
    company: "Kimpton AI",
    logo: "/assets/reports/kimpton-ai/logo.svg",
    logoNeedsBg: false,
    url: "https://l3cap.com",
    industry: "Cryptoasset investment management",
    pages: 8,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Site invisible to LP diligence searches",
        body: "Google can't identify Level III Capital as an investment firm in enhanced search results. Accredited investors vetting quantitative crypto managers this week may never see the firm during their research stage — and a site that isn't surfaced at that stage is invisible to the investor who would have been a fit.",
      },
      {
        label: "YC affiliation not visible in hero",
        body: "The YC P26 affiliation — a signal that changes how investors read the firm — isn't leading the homepage. Updating the hero and about page to reflect this affiliation is a same-day change that shifts every LP conversation from that moment forward, but on the current platform it gets deprioritized indefinitely.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to lead with our YC P26 affiliation and quantitative crypto focus",
      result1: "✓ It's live before your next LP conversation, and the signal that changes how investors read you is the first thing they see.",
      prompt2: "Add an Insights page — I want to publish our quantitative thesis on emerging blockchain inefficiencies",
      result2: "✓ You have a clean, credible content surface that builds trust with prospective LPs during diligence, and a URL you can share directly.",
      prompt3: "Add a short qualifier before the contact form — accredited investor confirmation and minimum check size",
      result3: "✓ Your inbound call quality improves immediately, and you stop spending time on conversations that aren't ready yet.",
    },
  },
  {
    id: "miss-cfo",
    company: "Miss CFO",
    logo: "/assets/reports/miss-cfo/logo.svg",
    logoNeedsBg: false,
    url: "https://miss-cfo.com",
    industry: "Financial management for film, TV, and media productions",
    pages: 5,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "No structured signal for production searches",
        body: "Google can't identify Miss CFO's services in enhanced search results. Film and TV productions searching for financial management this week may not find the firm in the research phase — and a financial firm that isn't visible during vendor research doesn't get added to the shortlist before the budget is locked.",
      },
      {
        label: "No social proof before the first call",
        body: "Productions need reassurance that the firm has handled work like theirs before they'll reach out. There's no client section or production credits visible on the site, which means every credibility question gets answered on the first call instead of before it — lengthening the sales cycle on every new inquiry.",
      },
    ],
    aiExamples: {
      prompt1: "Update the services section — I want Finance, Production, and Company Management each described clearly with what's included",
      result1: "✓ Productions understand exactly what they're getting before the first call, and you spend that call on fit, not explanation.",
      prompt2: "Add a client section — I want to show the types of productions we've worked with, even without naming clients by name",
      result2: "✓ Productions see themselves in your client list immediately, and the credibility question is answered before anyone asks.",
      prompt3: "Add a dedicated page for TV and streaming production financial management",
      result3: "✓ TV productions land on a page built for their specific context, and you stop qualifying scope from scratch on every discovery call.",
    },
  },
  {
    id: "mplus-maritime",
    company: "Mplus Maritime",
    logo: "/assets/reports/mplus-maritime/logo.svg",
    logoNeedsBg: false,
    url: "https://mplusmaritime.com",
    industry: "Marine surveying and maritime consulting",
    pages: 5,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Site invisible to Bay Area vessel searches",
        body: "Google can't fully identify MPlus Maritime as a marine consultancy — no structured data tells search engines what services are offered or where they operate. Vessel owners in the San Francisco Bay Area searching for a marine surveyor this week may not find the firm at all, even for the exact services it provides.",
      },
      {
        label: "Survey types share one undifferentiated page",
        body: "Pre-purchase, damage, and insurance surveys are distinct searches but share a single page with no separate entries. A vessel owner searching for a specific survey type lands on a competitor that has a dedicated page for that term. Each survey type needs its own findable surface to capture the traffic already searching for it.",
      },
    ],
    aiExamples: {
      prompt1: "Update the Services section to list pre-purchase surveys, damage surveys, and insurance surveys as separate entries with a one-line description each",
      result1: "✓ Each service is now findable in its own right — vessel owners searching for that specific survey type land on a page that speaks directly to what they need.",
      prompt2: "Add a short paragraph under Maritime Training explaining who the courses are for and what certification they lead to",
      result2: "✓ The training page stops being a dead end and starts converting curious visitors into enrolled students.",
      prompt3: "Rewrite the hero so it leads with 'Marine Surveyor serving the San Francisco Bay Area' and includes a direct contact link",
      result3: "✓ The headline now matches what vessel owners are actually typing into Google — and gives them a next step the moment they land.",
    },
  },
  {
    id: "press-kitchen",
    company: "Press Kitchen",
    logo: "/assets/reports/press-kitchen/logo.svg",
    logoNeedsBg: false,
    url: "https://presskitchen.com",
    industry: "Boutique PR / communications agency",
    pages: 6,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "No structured agency signal in search",
        body: "Search engines can't identify Press Kitchen as a PR agency in enhanced results — the site is missing structured data that tells Google what category of firm this is and what services it offers. Brands shortlisting agencies this week compare results that show structure and authority; Press Kitchen's result shows neither.",
      },
      {
        label: "Campaign wins sit off the site for weeks",
        body: "Adding a new case study to OUR WORK requires a WordPress plugin queue, image optimization, and formatting review — which means the win that would close the next client stays off the site long after the momentum fades. For an agency whose work speaks volumes, the window on a brand mid-comparison doesn't stay open long enough to wait on a WordPress update cycle.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero — change 'Stories That Shape Culture' to lead with the result: 'PR That Moves Culture and Closes Deals.'",
      result1: "✓ Live today. The brands searching for an agency that connects culture to business outcomes see it immediately — before they ever click through to a competitor.",
      prompt2: "Add the new Beautycon campaign to OUR WORK — same layout, the headline stat front and center.",
      result2: "✓ The case study that closes the next client is live the day the win is confirmed, not three weeks later.",
      prompt3: "I want 'We Turn Ideas Into Influence' to link to a lead form — not just sit as a tagline.",
      result3: "✓ Done in one conversation. The phrase that captures the agency's value proposition starts doing conversion work instead of just sitting on the page.",
    },
  },
  {
    id: "silicon-valley-circle",
    company: "Silicon Valley Circle",
    logo: "/assets/reports/silicon-valley-circle/logo.svg",
    logoNeedsBg: false,
    url: "https://svcircle.com",
    industry: "Career coaching / tech talent accelerator",
    pages: 5,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Flagship programs invisible in search",
        body: "Google can't identify Silicon Valley Circle's coaching programs in search results — the site is missing structured data that tells search engines what's offered and who it's for. Senior ML engineers and AI product managers comparing career advancement programs this week may not see SVC at all during their research window.",
      },
      {
        label: "New cohorts can't go live in time",
        body: "When a new cohort opens, updating the hero and adding a cohort page goes to a designer queue that takes one to two weeks — which means the program fills slower, or with candidates who found it by accident. The window to show up for a candidate at the exact moment they're ready to apply is narrow, and a delayed site update closes it.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero to announce our next AI Engineering cohort — applications open now",
      result1: "✓ It's live within the hour, and candidates searching for AI engineering career programs that week see an active, timely program — not a static page that looks the same as last quarter.",
      prompt2: "Add a dedicated page for our Product Management placement track with its own application flow",
      result2: "✓ PM candidates land on something built for them, conversion improves, and you have a clean URL to run paid or organic campaigns against.",
      prompt3: "Test a version of the CTA that emphasizes the exclusivity angle — 'Qualified Candidates Only'",
      result3: "✓ You know within a week whether it moves the needle, instead of leaving that conversion lift sitting on the table indefinitely.",
    },
  },
  {
    id: "wisdom-partners",
    company: "Wisdom Partners",
    logo: "/assets/reports/wisdom-partners/logo.svg",
    logoNeedsBg: false,
    url: "https://wisdompartners.llc",
    industry: "Executive coaching / peer advisory for founders",
    pages: 11,
    hostingCost: 23,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Google writes their search description",
        body: "Wisdom Partners has no meta description, so Google writes its own snippet for search results. Founders searching for executive coaching or peer advisory forums see whatever Google guessed — not the message Josh would choose. The window to show up for a founder at the exact moment they're ready to stop climbing alone closes before the site can make its case.",
      },
      {
        label: "Cohort pages lag behind actual openings",
        body: "When a cohort opens or a new program launches, updating the Pathways to Success page requires Squarespace's style editor and a designer review — which means the page doesn't reflect the current offer when qualified founders are looking. A landing page for a specific founder segment has been on the list for two quarters and hasn't shipped.",
      },
    ],
    aiExamples: {
      prompt1: "Update the hero — change 'We help founders succeed' to 'Peer advisory for founders who want to move faster than they could alone.'",
      result1: "✓ Live in minutes. The founders who resonate with that framing self-select before they ever book a call — better qualified leads from the same traffic.",
      prompt2: "Add a page for the new Q3 cohort — use the same layout as 'Who we've helped' but with an application form.",
      result2: "✓ New page is live the same day the cohort opens. No lag between announcement and the ability to apply.",
      prompt3: "Pull the Free Resources section up higher — I want it to be the second thing someone sees after the hero.",
      result3: "✓ Done in one conversation. The section that builds trust with skeptical founders is no longer buried at the bottom.",
    },
  },
  {
    id: "wit-ventures",
    company: "Wit Ventures, Inc.",
    logo: "/assets/reports/wit-ventures/logo.svg",
    logoNeedsBg: false,
    url: "https://witventures.net",
    industry: "Tech recruiting / staffing",
    pages: 5,
    hostingCost: 50,
    waitDays: 3,
    opportunityFindings: [
      {
        label: "Firm missing from recruiter search results",
        body: "Google can't surface Wit Ventures as a staffing agency in enhanced results — the site is missing structured data that tells search engines what recruiting services are offered and which companies are served. Rapid-growth startups actively hiring this week compare recruiters in search results and may never see Wit Ventures before they move on to someone else.",
      },
      {
        label: "Embedded services has no dedicated page",
        body: "Startups that need embedded recruiting land on a shared page and have to connect the dots themselves — which means the model gets explained from scratch on every discovery call. A dedicated Embedded Services page with its own pitch and contact flow would let the right clients self-select before they ever book a call.",
      },
    ],
    aiExamples: {
      prompt1: "Add a dedicated Embedded Services page — I want it to explain the model and have its own CTA",
      result1: "✓ Startups land on a page built for their specific hiring situation, and you stop explaining the model from scratch on every discovery call.",
      prompt2: "Update the hero to reflect our focus on rapid-growth startups — I want it sharper than 'relationship-driven tech recruiters'",
      result2: "✓ The founders who are your best-fit clients recognize themselves immediately, and the ones who aren't self-select out before they book a call.",
      prompt3: "Add a short case study or placement highlight from a recent Series A client",
      result3: "✓ You have proof on the page that closes the credibility gap before the first email, and a URL you can drop in outreach to let the site do the work.",
    },
  },
  {
    id: "capix",
